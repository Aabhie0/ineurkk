...
class dataBaseOperation:
    ...
    def __init__(self):
        ...
        self.cloud_config = {
            'secure_connect_bundle': r"C:\Users\lenovo\Desktop\Abhishek\aaiveur\Internship-Energy-Efficiency-main\energies efficies\secure-connect-energyefficiency.zip"}
        ...
        logger.info('INFO', 'Connection Is Created With DataStax Server')
    ...
    def useKeySpace(self):
        ...
        try:
            ...
            raise Exception(f"(useKeySpace) ~ Their must be precaution About useKeySpace Method \n" + str(e))
    ...
    def createTable(self):
        ...
        try:
            ...
            raise Exception(f"(createTable) - Caution About Creating Table Method \n" + str(e))
    ...
    def insertIntoTable(self):
        ...
        try:
            ...
            with open(file, mode='r') as f:
                ...
                # print('All Data Entred Into ineurk Database')
            ...
            raise Exception(f"(insertIntoData) ` CautionAbout Insert Into Data Method \n" + str(e))
    ...
    def getData(self):
        ...
        try:
            ...
            raise Exception(f"(getData) ~ Caution About getData Method \n" + str(e))
